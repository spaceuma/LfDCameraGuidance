...
plot(leftToolPos1(:,1),leftToolPos1(:,2),'y');
plot(leftToolPos2(:,1),leftToolPos2(:,2),'m');
plot(leftToolPos3(:,1),leftToolPos3(:,2),'c');
plot(leftToolPos4(:,1),leftToolPos4(:,2),'r');
plot(leftToolPos5(:,1),leftToolPos5(:,2),'b');
plot(leftToolPos6(:,1),leftToolPos6(:,2),'g');
plot(leftToolPos7(:,1),leftToolPos7(:,2),'k');
...
h(7) = plot(NaN,NaN,'k');
h(8) = plot(NaN,NaN,'og');
legend(h,'Training 1','Training 2','Training 3','Training 4','Training 5','Training 6','Training 7','GMM');
...
plot(rightToolPos1(:,1),rightToolPos1(:,2),'y');
plot(rightToolPos2(:,1),rightToolPos2(:,2),'m');
plot(rightToolPos3(:,1),rightToolPos3(:,2),'c');
plot(rightToolPos4(:,1),rightToolPos4(:,2),'r');
plot(rightToolPos5(:,1),rightToolPos5(:,2),'b');
plot(rightToolPos6(:,1),rightToolPos6(:,2),'g');
plot(rightToolPos7(:,1),rightToolPos7(:,2),'k');
...
plot(cameraPos1(:,1),cameraPos1(:,2),'y');
plot(cameraPos2(:,1),cameraPos2(:,2),'m');
plot(cameraPos3(:,1),cameraPos3(:,2),'c');
plot(cameraPos4(:,1),cameraPos4(:,2),'r');
plot(cameraPos5(:,1),cameraPos5(:,2),'b');
plot(cameraPos6(:,1),cameraPos6(:,2),'g');
plot(cameraPos7(:,1),cameraPos7(:,2),'k');
h = zeros(5, 1);
h(1) = plot(NaN,NaN,'y');
h(2) = plot(NaN,NaN,'m');
h(3) = plot(NaN,NaN,'c');
